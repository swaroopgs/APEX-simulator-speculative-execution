...
create_APEX_instruction(APEX_Instruction* ins, char* buffer)
{
  ...
  } else if (strcmp(ins->opcode, "ADD") == 0 || strcmp(ins->opcode, "SUB") == 0 || strcmp(ins->opcode, "MUL") == 0 || strcmp(ins->opcode, "LDR") == 0 || strcmp(ins->opcode, "AND") == 0
